<section class="paralax-mf footer-paralax bg-image sect-mt4 route" style="background-image: url(uploads/ui/overlay-bg.jpg)">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="more-info">
                                    ...
                                    <ul class="list-ico">
                                        <li><span class="ion-ios-location"></span> {{ $settings ->address }}
                                        </li>
                                        <li><span class="ion-ios-telephone"></span> {{ $settings ->contact_number }}</li>
                                        <li><span class="ion-email"></span> {{ $settings ->contact_email }}</li>
                                    </ul>
                                </div>
                                <div class="socials">
                                    <ul>
